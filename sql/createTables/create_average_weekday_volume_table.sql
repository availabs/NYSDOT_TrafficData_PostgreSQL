...
DROP TABLE IF EXISTS average_weekday_volume CASCADE;
...
COMMENT ON TABLE average_weekday_volume IS
...
COMMENT ON COLUMN average_weekday_volume.rc_station IS
...
COMMENT ON COLUMN average_weekday_volume.stat IS
...
COMMENT ON COLUMN average_weekday_volume.rcsta IS
...
COMMENT ON COLUMN average_weekday_volume.functional_class IS
'Functional Classification of the roadway segment to which the station applies.';

COMMENT ON COLUMN average_weekday_volume.factor_group IS
'Factor Group determines the set of seasonal factors to apply. Factor Groups are 30, 40, or 60 only.';

COMMENT ON COLUMN average_weekday_volume.latitude IS
'Latitude, in decimal degrees, of the primary counter placement.';

COMMENT ON COLUMN average_weekday_volume.longitude IS
'Longitude, in decimal degrees, of the primary counter placement.';

COMMENT ON COLUMN average_weekday_volume.specific_recorder_placement IS
'Verbal description of the primary counter placement.';

COMMENT ON COLUMN average_weekday_volume.channel_notes IS
...
COMMENT ON COLUMN average_weekday_volume.data_type IS
'A description of the data type contained in the file.';

COMMENT ON COLUMN average_weekday_volume.vehicle_axle_code IS
'Vehicle/Axle code in Volume files: 1=Vehicle count 2=Axles/2 count.';

COMMENT ON COLUMN average_weekday_volume.year IS
'The year in which the data was collected.';

COMMENT ON COLUMN average_weekday_volume.month IS
'The month in which the data was collected.';

COMMENT ON COLUMN average_weekday_volume.day_of_first_data IS
'The first day of data collection for the count.';

COMMENT ON COLUMN average_weekday_volume.federal_direction IS
...
COMMENT ON COLUMN average_weekday_volume.full_count IS
...
COMMENT ON COLUMN average_weekday_volume.d_factor IS
...
COMMENT ON COLUMN average_weekday_volume.flag_field IS
'A field designated to give additional information about a count.';

COMMENT ON COLUMN average_weekday_volume.batch_id IS
