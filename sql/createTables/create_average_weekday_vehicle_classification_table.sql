...
DROP TABLE IF EXISTS avg_weekday_vehicle_classification;

CREATE TABLE avg_weekday_vehicle_classification (
...
COMMENT ON TABLE avg_weekday_vehicle_classification IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.rc_station IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.stat IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.rcsta IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.functional_class IS
'Functional Classification of the roadway segment to which the station applies.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.factor_group IS
'Factor Group determines the set of seasonal factors to apply. Factor Groups are 30, 40, or 60 only.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.latitude IS
'Latitude, in decimal degrees, of the primary counter placement.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.longitude IS
'Longitude, in decimal degrees, of the primary counter placement.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.specific_recorder_placement IS
'Verbal description of the primary counter placement.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.channel_notes IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.data_type IS
'A description of the data type contained in the file.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.blank IS
'Blank in Classification data files.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.year IS
'The year in which the data was collected.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.month IS
'The month in which the data was collected.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.day_of_first_data IS
'The first day of data collection for the count.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.federal_direction IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.full_count IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f1s IS
'The number of vehicles in the FHWA F‐scheme class F1 (Motorcycles) as a daily total for the Average Weekday.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f2s IS
'The number of vehicles in the FHWA F‐scheme class F2 (Autos) as a daily total for the Average Weekday.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f3s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f4s IS
'The number of vehicles in the FHWA F‐scheme class F4 (Buses) as a daily total for the Average Weekday.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f5s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f6s IS
'The number of vehicles in the FHWA F‐scheme class F6 (3 axle single unit trucks) as a daily total for the Average Weekday.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f7s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f8s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f9s IS
'The number of vehicles in the FHWA F‐scheme class F9 (5 axle, single trailer) as a daily total for the Average Weekday.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f10s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f11s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f12s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.avg_wkday_f13s IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.cu_peak IS
...
COMMENT ON COLUMN avg_weekday_vehicle_classification.su_aadt IS
'Currently Blank. The number of Single Unit Vehicles, classes F4‐F7, during an Average Day.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.cu_aadt IS
'Currently Blank. The number of Combination Vehicles, classes F8‐F13, during an Average Day.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.flag_field IS
'A field designated to give additional information about a count.';

COMMENT ON COLUMN avg_weekday_vehicle_classification.batch_id IS
