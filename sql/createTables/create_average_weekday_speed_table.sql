...
DROP TABLE IF EXISTS avg_weekday_speed;
...
COMMENT ON TABLE avg_weekday_speed IS
...
COMMENT ON COLUMN avg_weekday_speed.rc_station IS
...
COMMENT ON COLUMN avg_weekday_speed.stat IS
...
COMMENT ON COLUMN avg_weekday_speed.rcsta IS
...
COMMENT ON COLUMN avg_weekday_speed.data_type IS
'A description of the data type contained in the file.';

COMMENT ON COLUMN avg_weekday_speed.speed_limit IS
'Speed_Limit for the count location in speed data files.';

COMMENT ON COLUMN avg_weekday_speed.year IS
'The year in which the data was collected.';

COMMENT ON COLUMN avg_weekday_speed.month IS
'The month in which the data was collected.';

COMMENT ON COLUMN avg_weekday_speed.day_of_first_data IS
'The first day of data collection for the count.';

COMMENT ON COLUMN avg_weekday_speed.federal_direction IS
...
COMMENT ON COLUMN avg_weekday_speed.full_count IS
