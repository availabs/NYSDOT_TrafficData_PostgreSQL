...
VALUES
  ...
  (39, 'Urban minor factor group.', 'Suburban minor factor group. Minor factor groups surround the major factor groups and are labelled +/-1 of the major factor group label. These minor factor groups are supplied to give the user a more fine-tuned calculation of the AADT.'),
  (40, 'Suburban', 'Suburban traffic patterns moderately affected by the seasons coefficient of variation >= 10% and < =25%'),
  (41, 'Urban minor factor group.', 'Suburban minor factor group. Minor factor groups surround the major factor groups and are labelled +/-1 of the major factor group label. These minor factor groups are supplied to give the user a more fine-tuned calculation of the AADT.'),
